...
public final class RSSReader {
    ...
    public static void main(String[] args) {
        ...
        out.print("Enter the name of the output file (including .html): ");
        String outputFileName = in.nextLine();

        SimpleWriter htmlFile = new SimpleWriter1L(outputFileName);
        ...
        if (rss.isTag() && rss.label().equals("rss") && rss.hasAttribute("version")
            ...
            out.println("HTML file generated successfully: " + outputFileName);
        } else {
